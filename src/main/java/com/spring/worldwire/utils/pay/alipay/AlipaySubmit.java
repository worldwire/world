...
import com.spring.worldwire.utils.MD5;
...
public class AlipaySubmit {
    ...
    public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        return MD5.sign(prestr, AlipayConfig.ALLINPAY_KEY_MD5, AlipayConfig.ALIPAY_INPUT_CHARSET);
    }
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\""
                + ALIPAY_GATEWAY_NEW + "_input_charset=" + AlipayConfig.ALIPAY_INPUT_CHARSET + "\" method=\"")
                .append(strMethod).append("\">");
...
/*    /**
    ...
    public static String buildRequest(String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+PayConfig.alipay_input_charset);
...
/*    /**
     ...
     * @throws MalformedURLException 解析异常
     */
    ...
    public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.ALIPAY_PARTNER + "&_input_charset" +AlipayConfig.ALIPAY_INPUT_CHARSET;
